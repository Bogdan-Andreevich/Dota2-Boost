      ...
      <div class="second-container">
        <div class="service-boost-head">
          <div class="service-boost-head-path">
            ...
            <p class="service-boost-head-path-text">{{__('ММР Буст')}}</p>
          </div>

          <div class="service-boost-head-titles">
            <h1 class="service-boost-head-titles-title">
                {{__('Замов послуги бустингу вже зараз!')}}
            </h1>
        ...
        <div class="service-boost-block">
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            alt="info-title"
                            src="{{asset('images/icons/info_600.svg')}}"
                          />
                            {{__('Особистий Кабінет')}}
                        </p>
                        <p
                        ...
                        >
                            {{__(' Вам буде створенний особистий кабінет у автоматичному
          ...
          <div class="service-boost-second">
            <h2 class="service-boost-second-title">{{__('Бустинг Рейтингу ММР')}}</h2>
